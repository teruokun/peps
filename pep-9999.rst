...
This PEP describes the Python Packaging Index (Warehouse) JSON API.
...
(e.g. client applications like pip, pipenv and more). It als aims to help other
...
It is guaranteed to always have **only** string top level key values.
...
The Python Packaging Index returns the following keys today, but are not guaranteed
...
# TODO: Find out if there is anything else done? @cooperlees only knows this
